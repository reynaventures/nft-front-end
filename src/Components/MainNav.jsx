    ...
    <StyledMainNav>
      ...
      <nav className="header__nav">
        ...
        <ul className="header__list">
            ...
            <li className="header__item header__item-social" title='Twitter'><a className='header-icon' target='__blank' href="https://twitter.com/eitnyworld"><AiOutlineTwitter className='header__nav-icon'/></a></li>
            <li className="header__item header__item-social" title='Discord'><a className='header-icon' target='__blank' href="https://discord.gg/RQT3DdMcTD"><FaDiscord className='header__nav-icon'/></a></li>
