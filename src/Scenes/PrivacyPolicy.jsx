                ...
                <main className="main">
                    ...
                    <h3 className="section__title">1. Personal Information</h3>
                        <ul className="section__list">
                            <li className="section__block">
                                <div className="section__content">
                                    <p className='section__content-text'>For the purposes of this Policy, “personal information” means any identifiable information about an individual, including but not limited to an individual’s name, home address, telephone number, email address, except any other information otherwise exempted by applicable law. </p>
                                    <p className='section__content-text'>When you use our Website or Service, we may collect the following personal information from you:</p>
                                    <p className='section__content-text'>- contact information such as name, email address, phone number, and business details; and
                                    - information generated from your access and use of the Website such as performance data of the Website (“Usage Data”)</p>
                                    <p className='section__content-text'>Your personal information may be collected when:</p>
                                    <p className='section__content-text'>- you fill out free-form fields on our Website 
                                    - you connect with us through social media;</p>
                                    <p className='section__content-text'>We only collect personal information that we need to provide the Service.  We encourage you to not provide us with any personal information beyond what is necessary and as requested by us.</p>
                                    <p className='section__content-text'>Collection from Third Parties</p>
                                    <p className='section__content-text'>We do not knowingly collect your personal information from a third party unless you consent or we are otherwise exempted, required or permitted by applicable laws to do so.  For example, we may collect your personal information from the following third parties:</p>
                                    <p className='section__content-text'>- your authorized representative(s);
                                    - organization(s) that you previously consented to collect your personal information; or
                                    - public sources in which your personal information is publicly available.</p>
                                    <p className='section__content-text'>If we collect your personal information from a third party, we will only process that information for the specific purpose for which it was provided to us in accordance with this Policy and the policy under which that information was collected.</p>\]
                                    <p className='section__content-text'>Links to Other Sites
                                        ...
                                        Our service is intended solely for users who are 13 years of age or older.</p>
                                    <p className='section__content-text'>We do not knowingly collect personal information about any person under the age of 13. No such minor, nor any parent or guardian as it relates to such minor, should submit such minor’s personal information to us through the Website, or otherwise for any reason and under any circumstances. </p>
                                    <p className='section__content-text'>If you believe that a minor has provided us with personal information without parental consent, please contact us at the address indicated in Section 10 below and we will work to delete that data from our systems.</p>
                                </div>
                            </li>
                        </ul>
                    </section>
                    <section className="main__section">
                        ...
                        <ul className="section__list">
                            <li className="section__block">
                                <div className="section__content">
                                <p className='section__content-text'>We may process your personal information for the following purposes (the “Purposes”):</p>
                                <p className='section__content-text'>- to verify and authenticate your identity;
                                    ...
                                    We will only process your personal information for the Purposes for which we intend to process such information.  Otherwise, we will not process your personal information without your consent.</p>
                                </div>
                            </li>
                        </ul>
                    </section>
                    <section className="main__section">
                        ...
                        <ul className="section__list">
                            <li className="section__block">
                                <div className="section__content">
                                    <p className='section__content-text'>We may disclose your personal information for the Purposes as described in this Policy in the following ways:</p>
                                    <p className='section__content-text'> to our employees and contractors;
                                    ...
                                    Your personal information that we collect may be processed outside of the United States but only in relation to the Purposes. As a result, your personal information may be accessible to law enforcement and regulatory authorities in accordance with other jurisdictions’ applicable laws.</p>
                                </div>
                        </li>
                        </ul>
                    </section>
                        ...
                        <ul className="section__list">
                            <li className="section__block">
                                <div className="section__content">
                                    ...
                                    Aside from consent, we may also process your personal information under other legal bases, as permitted by the applicable laws.</p>
                                </div>
                            </li>
                        </ul>
                    </section>
                    <section className="main__section">
                        ...
                        <ul className="section__list">
                            <li className="section__block">
                                <div className="section__content">
                                    <p className='section__content-text'>The security of your personal information is important to us. We protect personal information using physical, technological and organizational safeguards. We regularly review our practices to ensure they align with reasonable industry practices appropriate to the level of sensitivity to safeguard personal information against loss or theft, unauthorized access, alteration or disclosure.</p>
                                    <p className='section__content-text'>However, no method of transmission over the Internet, or method of electronic storage, is completely secure. As such, despite our safeguards and protocols, we cannot fully guarantee the security of your personal information and you should always exercise caution when disclosing personal information over the Internet.</p>
                                </div>
                            </li>
                        </ul>
                    </section>
                    <section className="main__section">
                        ...
                        <ul className="section__list">
                            <li className="section__block">
                                <div className="section__content">
                                    <p className='section__content-text'>Applicable privacy laws allow, to varying degrees, individuals the right to access or request the correction of errors or omissions in their personal information that is in our custody or under our control. You may request access to and review of your personal information in our possession. However, access may be declined where permitted or required by applicable law.</p>
                                    <p className='section__content-text'>You may request that we correct your personal information in our possession. We reserve the right not to change any personal information if we do not agree that it is inaccurate or outdated, but will append any alternative text the individual concerned believes appropriate.
                                    If access cannot be provided, we will notify the individual making the request within 30 days, in writing, of the reasons for the refusal.</p>
                                </div>
                            </li>
                        </ul>
                    </section>
                    <section className="main__section">
                        ...
                        <ul className="section__list">
                            <li className="section__block">
                                <div className="section__content">
                                    <p className='section__content-text'>We are committed to compliance with anti-spam legislation. Any commercial electronic messages (“CEMs”) we send to outside parties are protected by a range of business procedures, processes and policies to ensure that such communication is done in compliance with such laws.</p>
                                    <p className='section__content-text'>- Consent — We do not send you CEMs without your consent. This consent typically must be “express” (expressly acknowledged by you), but in certain circumstances can be “implied” or specifically exempt from consent requirements.  We created our sign-up, registration and consent forms in order to ensure that your consent is meaningful (i.e. informed and freely given) as in accordance with applicable law.  When we collect your electronic contact information, you will know the exact purposes behind the collection.
                    ...
                    <section className="main__section">
                        ...
                        <ul className="section__list">
                            <li className="section__block">
                                <div className="section__content">
                                    <p className='section__content-text'>You can direct any questions or concerns regarding our compliance with this Policy and our processing of your personal information to our Privacy Officer by emailing privacy@reyna.ventures.</p>
                                    <p className='section__content-text'>If you are not satisfied with our Privacy Officer’s response to your question or concern, you may be able to file a complaint under applicable privacy laws.  Our Privacy Officer will provide you with the contact information to do so if requested. We strive to offer an accessible and simple complaint procedure. We will promptly investigate all complaints received, and if a complaint is justified, we will take the necessary steps to resolve the issue in question.</p>
                                </div>
                            </li>
                        </ul>
                    </section>
